...
type CallbackName<Name extends string> =
  Name extends keyof ExceptionalCallbackNames
    ? ExceptionalCallbackNames[Name]
    : RegularCallbackName<Name>;

type NormalSetterName<Name extends string> = Name;
type BooleanSetterName<Name extends string> = `is${Capitalize<Name>}`;
type SetterName<Name extends string, Value> = Value extends boolean
  ? BooleanSetterName<Name>
  : NormalSetterName<Name>;

type ObjectWithKey<Key extends string, Value> = { [key in Key]: Value };
type ObjectWithOptionalKey<Key extends string, Value> = {
  [key in Key]?: Value;
};
type ObjectWithoutKey<Key extends string> = { [key in Key]?: never };

type ExplicitUncontrolledModeProps<
  Name extends string,
  Value,
> = ObjectWithoutKey<SetterName<Name, Value>> &
  ObjectWithoutKey<CallbackName<Name>> &
  ObjectWithKey<DefaultValueName<Name>, Value>;

type ImplicitUncontrolledModeProps<
  Name extends string,
  Value,
> = ObjectWithoutKey<SetterName<Name, Value>> &
  ObjectWithoutKey<CallbackName<Name>> &
  ObjectWithOptionalKey<DefaultValueName<Name>, Value>;

type ImplicitTraceableUncontrolledModeProps<
  Name extends string,
  Value,
> = ObjectWithoutKey<SetterName<Name, Value>> &
  ObjectWithOptionalKey<CallbackName<Name>, (value: Value) => void> &
  ObjectWithOptionalKey<DefaultValueName<Name>, Value>;

type ControlledModeProps<Name extends string, Value> = ObjectWithKey<
  SetterName<Name, Value>,
  Value
> &
  ObjectWithOptionalKey<CallbackName<Name>, (value: Value) => void> &
  ObjectWithoutKey<DefaultValueName<Name>>;
 ...
 */
export type ExplicitMixedControlProps<Name extends AllowedFieldNames, Value> =
  | ExplicitUncontrolledModeProps<Name, Value>
  | ControlledModeProps<Name, Value>;
 ...
 */
export type ImplicitMixedControlProps<Name extends AllowedFieldNames, Value> =
  | ImplicitUncontrolledModeProps<Name, Value>
  | ControlledModeProps<Name, Value>;
 ...
 */
export type ImplicitTraceableMixedControlProps<
  Name extends AllowedFieldNames,
  Value,
> =
  | ImplicitTraceableUncontrolledModeProps<Name, Value>
  | ControlledModeProps<Name, Value>;
